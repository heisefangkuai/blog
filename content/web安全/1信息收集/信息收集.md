...
1. 域名、rebost.txt
2. whois信息、备案信息、DNS记录、ip、端口
3. 网站子域名
4. 敏感目录和文件
5. 网站指纹：服务器(Linux/Windows)、网站容器(Apache/Nginx/Tomcat/IIS)、脚本(php/jsp/asp/aspx)、数据库(Mysql/Oracle/Accees/Mqlserver/...)
6. 旁站和C段
7. Github/SVN信息：泄露源码，敏感信息等
8. Google搜索语法/Github搜索语法
9. APP收集/公众号&小程序
10. 公司信息收集
11. 邮箱信息
12. 其他信息(网盘信息)
